    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-basmati-bg p-4">
            <Neo_Card className="w-full max-w-md flex flex-col gap-6 bg-white">
                ...
                >
                    {show_dev_login ? '▲ Ocultar login de desarrollo' : '▼ Login de desarrollo (para pruebas)'}
                </button>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-2 mt-4">
                            ...
                            >
                                ...
                                <span className="text-gray-400 text-xs ml-2">{DEV_USER_1.email}</span>
                            </button>
                            <button
                                type="button"
                            ...
                            >
                                ...
                                <span className="text-gray-400 text-xs ml-2">{DEV_USER_2.email}</span>
                            </button>
                        </div>
                    </div>
                )}
