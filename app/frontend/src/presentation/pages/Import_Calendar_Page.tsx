        ...
        <MainLayout>
            <div className="flex justify-center">
                <div className="w-full max-w-2xl">
                    <h1 className="text-3xl font-black uppercase mb-6">Importar Calendario</h1>
                    ...
                    {active_tab === 'google' && (
                        <Neo_Card title="Importar desde Google">
                            <form onSubmit={handle_google_import} className="flex flex-col gap-4">
                                ...
                                />
                                <p className="text-xs text-gray-500 -mt-3">Separados por comas. Dejar en blanco para importar el principal.</p>
                        ...
                        <Neo_Card title="Importar desde Teamup">
                            <form onSubmit={handle_teamup_import} className="flex flex-col gap-4">
                                <Neo_Input 
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 -mt-3">La parte de la URL después de teamup.com/ (ej. ks123456)</p>
                                ...
                                />
                                <p className="text-xs text-gray-500 -mt-3">Si se deja vacío, se usará la API Key del sistema.</p>
