    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-col gap-4">
                {weeks.map((week) => (
                    <div key={week} className="grid grid-cols-7 gap-4 h-32">
                        {days.map((day, index) => (
                            <div 
                                key={day} 
                                className="bg-white border-3 border-basmati-black shadow-hard p-2 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(26,26,26,1)] transition-all cursor-pointer relative"
                            >
    ...
    return (
        <MainLayout>
            <div className="flex justify-between items-end mb-8">
                <div>
                    <h2 className="text-4xl font-black uppercase mb-1">Septiembre 2025</h2>
                    <p className="font-medium text-gray-600">La vida es eso que pasa mientras haces otros planes.</p>
                </div>
                <div className="flex gap-2">
                    <Neo_Button variant="secondary">Mes</Neo_Button>
                    <Neo_Button variant="secondary">Semana</Neo_Button>
                    <Neo_Button variant="secondary">Día</Neo_Button>
                </div>
            </div>
