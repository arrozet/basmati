...
def create_events_router(get_service_dependency) -> APIRouter:
    ...
    @router.get(
        ...
        description="Busca en título, descripción y ubicación.",
        responses={
    ...
    @router.get(
        ...
        description="Busca eventos por título del calendario (campo denormalizado).",
        responses={
            200: {"description": "Lista de eventos del calendario."},
            500: {"description": "Error interno del servidor."}
        }
    ...
    @router.get(
        ...
        description="Busca eventos por dirección o nombre del lugar.",
        responses={
    ...
    @router.get(
        ...
        description="Busca por título, organizador (calendario) y palabras clave (descripción).",
        responses={
            200: {"description": "Lista de eventos que coinciden."},
            500: {"description": "Error interno del servidor."}
        }
    ...
    async def search_advanced(
        ...
        return await service.search_advanced(
            title=title,
            calendar_title=organizer,
